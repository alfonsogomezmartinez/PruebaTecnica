...
TEST(Bloque1, Ejercicio8){
    string in = "../test/Bloque1Ejercicio8.txt";
    pair<int, int> out = analyseFileDtectECBBlock(in);
    pair<int, int> expect = {1321, 1323};
...
TEST(Bloque2, Ejercicio3){
    string filename = "../test/expectBloque1Ejercicio7.txt";
    pair<string, bool> out = fileTestB2E3(filename);
